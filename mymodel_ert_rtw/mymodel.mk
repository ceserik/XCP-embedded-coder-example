...
COMPILER_COMMAND_FILE     = mymodel_comp.rsp
CMD_FILE                  = mymodel.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mymodel.exe
...
DEFINES_STANDARD = -DMODEL=mymodel -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/mymodel_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/mymodel_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/mymodel_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/mymodel_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/mymodel_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.obj : $(START_DIR)/mymodel_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mymodel.obj : $(START_DIR)/mymodel_ert_rtw/mymodel.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mymodel_data.obj : $(START_DIR)/mymodel_ert_rtw/mymodel_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
